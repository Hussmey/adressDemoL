...
@section('navbar-title', 'تحرير الدور')

@section('content')
<div class="row">
    <div class="col-lg-12 margin-tb">
        <h3 class="text-center">تحرير الدور</h3>
                ...
                @foreach($permission as $value)
                    <div class="col-md-3">
                        <div class="form-check form-switch py-1">
                            {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions), array('class' => 'form-check-input name', 'id' => 'permission_'.$value->id)) }}
